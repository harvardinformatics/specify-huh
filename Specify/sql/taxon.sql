select t.container_id,
       ...
       (select name from botanist_name where botanist_id=t.par_author_id and type_id=110105) as par_author,
       (select name from botanist_name where botanist_id=t.par_ex_author_id and type_id=110105) as par_ex_author,
       (select name from botanist_name where botanist_id=t.std_author_id and type_id=110105) as std_author,
       (select name from botanist_name where botanist_id=t.std_ex_author_id and type_id=110105) as std_ex_author

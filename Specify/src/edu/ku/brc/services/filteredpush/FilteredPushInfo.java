...
/**
 * This class holds the magic fields information for Filtered Push querying. Templated on CarryForwardInfo.
 *
 * @code_status Alpha
 *
 * @author mkelly
...
public class FilteredPushInfo
{
    ...
    protected FpFormViewObj       fpFormViewObj;
     ...
     * @param formViewDef
     */
    public FilteredPushInfo(final Class<?> classObj, 
                            final FpFormViewObj formViewObj, 
                            final FormViewDefIFace formViewDef)
    {
        this.fpFormViewObj = formViewObj;
    ...
    public void add(final List<FVOFieldInfo> items)
    {
        ...
        fpFormViewObj.setDoCarryForward(true);
    }
    ...
    public void remove(final String id)
    {
        ...
        if (fvoFieldInfo != null && fvoFieldInfo.getFormCell() instanceof FormCellField)
        {
            ...
            fpFormViewObj.setMagic(fieldList.size() > 0);
        }
    }
    ...
    private boolean isClonable(final Object obj)
    {
        ...
        } catch (Exception ex) 
        {
            ...
            edu.ku.brc.exceptions.ExceptionTracker.getInstance().capture(FilteredPushInfo.class, ex);
        }
        return false;
    }
     ...
     */
    private void cloneFPField(final String fieldName,
                                       ...
                                       final Object             newData)
    {
            ...
            ((UIPluginable)fvoFieldInfo.getComp()).canCarryForward())
        {
            ...
            if (fieldNames != null)
            {
                for (String fldName : fieldNames)
                {
                    ...
                    {
                        cloneFPField(fldName, fieldDataValue, newData);
                    } else
                    {
        ...
        {
            cloneFPField(fieldName, fieldDataValue, newData);
        } else
        {

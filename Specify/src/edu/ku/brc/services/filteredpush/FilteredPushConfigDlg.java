 ...
 *
 */
public class FilteredPushConfigDlg extends CustomDialog
{
    private static final Logger log = Logger.getLogger(FilteredPushConfigDlg.class);
     ...
     *
     */
    public FilteredPushConfigDlg(final MultiView mvParent)
    {

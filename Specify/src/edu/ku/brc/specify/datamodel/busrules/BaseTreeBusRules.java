                                       ...
                                       extends AttachmentOwnerBaseBusRules
{
    ...
    public void initialize(Viewable viewableArg)
    {
        ...
        if (formViewObj != null) // added by HUH: formViewObj may be if this is a table view object
        {
    ...
    */
                                           ...
                                           final T nodeInForm)
    {
		...
		// aded by HUH: sort tree def items by name
        ...
        while (!done)
        {
			...
			ranksByName.put(item.getName(), item); // aded by HUH: sort tree def items by name
        ...
        // added by HUH: sort tree def items by name

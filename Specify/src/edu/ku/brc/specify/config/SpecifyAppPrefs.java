...
public class SpecifyAppPrefs
{
    ...
    public static void loadColorAndFormatPrefs()
    {
        ...
        AppPrefsCache.register(AppPrefsCache.getDefaultDatePattern(), "ui", "formatting", "scrdateformatmon"); // added by HUH: implement 3-char alpha month names in date formatters
        ...
        AppPrefsCache.register(viewFieldColor, "ui", "formatting", "viewfieldcolor");
         ...
         // added by HUH: add border around ValComboBoxFromQuery text fields to make them more obvious; color is selectable as preference

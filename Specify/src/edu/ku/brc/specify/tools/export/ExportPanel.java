...
public class ExportPanel extends JPanel implements QBDataSourceListenerIFace
{
			...
			boolean getColInfo, boolean rebuildExistingTbl)
	{
        ...
        try
        {
        	...
        	{
        		HQLSpecs sql2 = QueryBldrPane.buildHQL(rootQRI, !includeRecordIds, qfps, tblTree, null, 
            		exportQuery.getSearchSynonymy() == null ? false : exportQuery.getSearchSynonymy(),
            				true, null);
        ...
        return new Specs(sql, cols, uniquenessHQL);
	}
    ...
    private class Specs 
    {
    	...
    	public Specs(HQLSpecs specs, List<ERTICaptionInfoQB> cols, String uniquenessHQL)
    	{
    		this.specs = specs;
    		this.cols = cols;

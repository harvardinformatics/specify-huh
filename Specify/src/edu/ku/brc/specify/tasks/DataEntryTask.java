                ...
                if (tableInfo != null)
                {
                    if (!tableInfo.isHidden())
                    {
                        ...
                        if (dev.isSideBar())
                        {
                            ...
                            String title = dev.getTitle() == null ? tableInfo.getTitle() : dev.getTitle();
                            
                            NavBoxItemIFace nbi = NavBox.createBtnWithTT(title, dev.getIconName(), dev.getToolTip(), IconManager.STD_ICON_SIZE, nba);

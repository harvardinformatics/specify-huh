...
public class PartialDateFormatter extends UIFieldFormatter
{
    ...
    public Object formatToUI(Object... datas)
    {
        ...
        {
        	// modified by HUH: moved this statement inside the if block to prevent null pointers when  datas.length < 1
            ...
            {
            	// modified by HUH: changed handling of month partial dates to be similar to year partial dates rather than to full dates

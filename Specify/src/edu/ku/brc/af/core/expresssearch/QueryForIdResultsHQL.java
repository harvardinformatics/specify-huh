...
public class QueryForIdResultsHQL implements QueryForIdResultsIFace
{
    ...
    protected void buildCaptions()
    {
        ...
        {
            // modified by HUH: do not ignore formatter declared on DisplayFielConfig dfc (i.e. from search_config.xml); if not found, look for it on dfc's field info (i.e. from specify_datamodel.xml)
            ...
            ERTICaptionInfo caption = new ERTICaptionInfo(dfc.getFieldInfo().getColumn(), 
                                                          ...
                                                          true,
                                                          dfc.getFieldInfo().getFormatter(), //modified by HUH
                                                          i+1);

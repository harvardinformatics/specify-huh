...
import static edu.ku.brc.ui.UIRegistry.getResourceString; // added by HUH: add "warning" to business rules status list
...
import javax.swing.JOptionPane;  // added by HUH: add "warning" to business rules status list
        ...
        if (viewBasedPanel.isEditMode())
        {
            ...
            if (fvo != null)
            {
                ...
                if (br != null && fvo.getDataObj() != null)
                {
                    ...
                    {
                    	// modified by HUH: add "warning" to business rules status list
                        BusinessRulesIFace.STATUS status = br.processBusinessRules(parentDataObj, 
                                                                                fvo.getDataObj(), 
                                                                                isNewObj);  

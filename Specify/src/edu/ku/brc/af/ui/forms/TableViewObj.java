    ...
    class ColumnInfo
    {
        ...
        protected void checkForDataObjFormatter()
        {
            ...
            if (formCell instanceof FormCellField)
            {
                ...
                // modified by HUH: fixes bug that compared FormCellField.getDspUIType() value to a String (it's not) and obtained data obj format name from viewdef cell@formatname rather than cell@initialize
    ...
    public class ColTableModel extends DefaultTableModel
    {
        ...
        public Object getValueAt(int row, int column)
        {
            ...
            if (columnList != null && dataObjList != null && dataObjList.size() > 0)
            {
				...
				// added by HUH: look for uiformatter before call to UIHelper.getFieldValues, to prevent default date formatting

...
import java.util.StringTokenizer; // added by HUH: added implementation of dot notation from UIHelper to getValue(final FormDataObjIFace dataObj, final String fieldName)
...
import edu.ku.brc.af.ui.forms.formatters.UIFieldFormatterIFace;  // added by HUH: added implementation of dot notation from UIHelper to getValue(final FormDataObjIFace dataObj, final String fieldName)
...
public final class FormHelper
{
    ...
    /** added by HUH: overloaded createandnewdataobject to take formview obj as an argument so that businessrules created from lookup on table listing can be initialized
   ...
   public static FormDataObjIFace createAndNewDataObj(final String newDataClassName, final Boolean overrideAddKids)
   {
    ...
    public static Object getValue(final FormDataObjIFace dataObj, final String fieldName)
    {
        if (dataObj != null)
        {
            ...
            if (getter != null)
            {
                 // added by HUH: added implementation of dot notation from UIHelper to getValue(final FormDataObjIFace dataObj, final String fieldName)
                Object dataValue;

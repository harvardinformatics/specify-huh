...
import java.util.HashSet; // added by HUH: only include distinct rows in aggregated results in express search
...
//            }
            ...
            for (Object obj : itemsAsCol)
            {
                if (obj != null)
                {
                    // modified by HUH: only add distinct rows in aggregated results for express search
                    String string;

...
public class GenericStringUIFieldFormatter extends BaseUIFieldFormatter
{
                                         ...
                                         final int      uiDisplayLen)
    {
        ...
        DBFieldInfo fi = ti.getFieldByName(fieldName.contains(".") ? fieldName.substring(fieldName.lastIndexOf(".")+1) : fieldName); // modified by HUH: get childInfo from substring of field name following last "." if "." appears, rather than from just the whole field name

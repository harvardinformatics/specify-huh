...
import javax.swing.border.BevelBorder; // added by HUH: create etched border around subviews to add visual form disambiguation clues
                                    ...
                                    PropertyChangeListener
{
    ...
    protected void createNewDataObject(final boolean doSetIntoAndValidateArg)
    {
        ...
        } else
        {
            ...
            {
                // modified by HUH: overloaded createandnewdataobject to take formview obj as an argument so that businessrules created from lookup on table listing can be initialized
    ...
    /** modified by HUH: check business rules before enabling delete button on current object in result set controller
     * @param mv
     * @return
     */
    ...
    protected void addRSController(final boolean addSearch)
    {
        ...
        if (rsController == null && controlPanel != null)
        {
            ...
            // added by HUH: create etched border around subviews to add visual form disambiguation clues
            else
            {
    ...
    protected void updateControllerUI()
    {
        ...
        // added by HUH: check business rules before enabling delete button on current object in result set controller

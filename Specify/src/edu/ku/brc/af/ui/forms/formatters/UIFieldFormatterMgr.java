...
public class UIFieldFormatterMgr implements AppPrefsChangeListener
{
    ...
    public UIFieldFormatterIFace createFormatterFromXML(final Element formatElement)
    {
        ...
        if (external != null)
        {
            ...
            if (StringUtils.isNotEmpty(externalClassName))
            {
                try
                {
                    ...
                    // added by HUH: checks for nulls returned by formatter.getFields() in the createFromXml methods
                    boolean isSingleField = formatter.getFields() != null && formatter.getFields().size() == 1;
                    
                    formatter.setName(name);
                    formatter.setAutoNumber(createAutoNum(formatElement, name, dataClassName, fieldName, isSingleField)); // modified by HUH: checks for nulls returned by formatter.getFields() in the createFromXml methods
        ...
        for (Object fldObj : fieldsList)
        {
            ...
            {
            	// removed by HUH: implement 2-char date formatting
            	// size = 4;
        ...
        // modified by HUH: checks for nulls returned by formatter.getFields() in the createFromXml methods
    ...
    */
    ...
    // added by HUH: implement 2-char date formatting
    /**

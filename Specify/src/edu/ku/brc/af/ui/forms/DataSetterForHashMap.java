...
public class DataSetterForHashMap implements DataObjectSettable
{
    ...
    {
        if (dataObj != null) // modified by HUH: fixed bug that persisted search field values removed by the user
        {
            if (!(dataObj instanceof Map))
            {
             ...
             // modified by HUH: fixed bug that persisted search field values removed by the user
            if (data == null)
            {

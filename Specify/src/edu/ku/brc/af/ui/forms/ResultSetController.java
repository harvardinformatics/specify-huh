...
public class ResultSetController implements ValidationListener
{
    ...
    protected String  objTitle   = null; // added by HUH: add object title to subview results navigation for visual disambiguation of forms 
                               ...
                               final boolean doLayoutBtns)
    {
        ...
        this.objTitle      = objTitle; // added by HUH: add object title to subview results navigation for visual disambiguation of forms
    ...
    public void updateUI()
    {
        ...
        // modified by HUH: add object title to subview results navigation for visual disambiguation of forms

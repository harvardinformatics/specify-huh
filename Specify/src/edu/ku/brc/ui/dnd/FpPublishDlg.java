...
public class FpPublishDlg extends JDialog implements ActionListener, ListSelectionListener
{
    // Static Data Members
    private static final Logger log = Logger.getLogger(FpPublishDlg.class);

    // Data Members
    protected JButton        restoreBtn;
    protected JButton        okBtn;
    protected JList          list;
    protected java.util.List<DndFpPublishable> items;
    protected FpPublish      fpPub;
     ...
     */
    public FpPublishDlg(final Frame frame) throws HeadlessException
    {
        super(frame, true);
    ...
    protected void createUI()
    {
        ...
        } catch (Exception ex)
        {
            ...
            edu.ku.brc.exceptions.ExceptionTracker.getInstance().capture(FpPublishDlg.class, ex);
            log.error(ex);
        }
     ...
     */
    public DndFpPublishable getFpPublishable()
    {

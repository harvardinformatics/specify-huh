...
/**
 * Interface for object that can be published on the FP network, it makes the 
 * object responsible for knowing how to get itself published, instead of someone else.
 * Patterned after DndDeletable.
 * 
 * @code_status Alpha
 * 
 * @author mkelly
 *
 */
public interface DndFpPublishable
{
    /**
     ...
     */
    public void setFpPublishCommandAction(final CommandAction cmdAction);

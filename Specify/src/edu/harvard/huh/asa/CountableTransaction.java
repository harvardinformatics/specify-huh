...
public class CountableTransaction extends Transaction
{
    ...
    {
        String itemCounts = null;

        if (typeCount != null || nonSpecimenCount != null)
        {
            if (typeCount == null) itemCounts = nonSpecimenCount + " non-specimens";
            else if (nonSpecimenCount == null) itemCounts = typeCount + " types";
            else itemCounts = nonSpecimenCount + " non-specimens and " + typeCount + " types";
        }
        
        if (itemCounts != null) itemCounts = "Quantity contains " + itemCounts + ".";

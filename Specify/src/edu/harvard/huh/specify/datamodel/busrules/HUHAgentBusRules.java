 ...
 * 
 * This class was created from AgentBusRules.
 * 
 * @author mkelly
 *
 */
...
{    
                                         ...
                                         final boolean doSetOtherValues)
    {
        ...
        enableFieldAndLabel(ABBREV, isOrganization, doSetOtherValues ? agent.getAbbreviation() : null, agent);
        // address is handled in fixUpTypeCBX
        enableFieldAndLabel(FIRST_NAME, isPerson, doSetOtherValues ? agent.getFirstName() : null, agent);
        setVisible(GROUP_PERSONS, isGroup);
        enableFieldAndLabel(DATES_TYPE, true, doSetOtherValues ? agent.getMiddleInitial() : null, agent);
        enableFieldAndLabel(INITIALS, isPerson, doSetOtherValues ? agent.getInitials() : null, agent);
        enableFieldAndLabel(INTERESTS, isPerson, doSetOtherValues ? agent.getInterests() : null, agent);
        enableFieldAndLabel(JOB_TITLE, isPerson, doSetOtherValues ? agent.getJobTitle() : null, agent);
        enableFieldAndLabel(TITLE, isPerson, doSetOtherValues ? agent.getTitle() : null, agent);

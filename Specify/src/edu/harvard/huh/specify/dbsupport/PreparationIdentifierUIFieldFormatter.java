 ...
 *
 */
public class PreparationIdentifierUIFieldFormatter extends BaseUIFieldFormatter implements UIFieldFormatterIFace
{
    /**
     * 
     */
    public PreparationIdentifierUIFieldFormatter()
    {
        super();
        this.name          = "PreparationIdentifierFormatter"; //$NON-NLS-1$ //TODO
        this.title         = UIRegistry.getResourceString("PreparationIdentifierUIFieldFormatter.NumericFormatter"); //$NON-NLS-1$; //TODO

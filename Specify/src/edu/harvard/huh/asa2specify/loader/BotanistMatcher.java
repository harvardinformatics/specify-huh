...
public class BotanistMatcher
{
    private static final Logger log  = Logger.getLogger(BotanistMatcher.class);

    private File csvFile;
    private LineIterator lineIterator;
    private Hashtable<Integer, Integer> botanistIdsByOtherId;

    public BotanistMatcher(File csvFile) throws LocalException
    {
        this.csvFile = csvFile;
        this.botanistIdsByOtherId = new Hashtable<Integer, Integer>();
        ...
        while (true)
        {
            ...
            try
            {
                ...
                botanistIdsByOtherId.put(affiliateId, botanistId);
            }
    ...
    void clear()
    {
        botanistIdsByOtherId.clear();
    }

    Integer getBotanistId(Integer affiliateId)
    {
        return botanistIdsByOtherId.get(affiliateId);
    }

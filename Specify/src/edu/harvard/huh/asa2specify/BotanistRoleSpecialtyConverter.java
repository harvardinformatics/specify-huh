...
public class BotanistRoleSpecialtyConverter
{
    private static final Logger log  = Logger.getLogger( BotanistRoleSpecialtyConverter.class );

    private static BotanistRoleSpecialtyConverter instance = new BotanistRoleSpecialtyConverter();
    
    private BotanistRoleSpecialtyConverter() {
        ;
    }
    
    public static BotanistRoleSpecialtyConverter getInstance() {
        return instance;
    }
    
    public AgentSpecialty convert(BotanistRoleSpecialty botanistRoleSpecialty) {

                                           ...
                                           final SCOPE  scope)
    {
        ...
        try
        {
            ...
            } else
            {
                ...
                Timestamp timestamp = semaphore.getLockedTime();
                if (timestamp != null) lockedTimeStr = timestamp.toString();
                
                String msg = UIRegistry.getLocalizedMessage("SpTaskSemaphore.IN_USE_OV_UNLK", title, userStr, lockedTimeStr);

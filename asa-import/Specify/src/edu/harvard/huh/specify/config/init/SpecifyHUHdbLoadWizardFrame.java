...
/**
 * @author maureen, using SpecifyDBSetupWizardFrame
 *
 * @code_status Alpha
 *
 * Apr 24, 2009
 *
 */
public class SpecifyHUHdbLoadWizardFrame extends JFrame implements FrameworkAppIFace
{
    /**
     * @throws HeadlessException
     */
    public SpecifyHUHdbLoadWizardFrame() throws HeadlessException
    {
        super();
        ...
        SpecifyHUHdbLoadWizard wizPanel = new SpecifyHUHdbLoadWizard( 
                new SpecifyHUHdbLoadWizard.WizardListener() {
                    @Override
    ...
    public static void main(String[] args)
    {
        ...
        SwingUtilities.invokeLater(new Runnable()
        {
            public void run()
            {
                ...
                SpecifyHUHdbLoadWizardFrame setup = new SpecifyHUHdbLoadWizardFrame();
